...
batch_size = int(config['batch_size_8']['batch_size'])
optimizer = eval(f"optim.{config['multilabel_DinoS_Parameters_test']['optimizer']}")
...
FILENAME = "random_sampling_results_for_multilabel_classification_s46.pickle"
NO_OF_ITERATIONS = 14
SPECIFIC_PATH = 'RandomSampling/Multilabel/DinoS/seed_46_config2_lowLR'
