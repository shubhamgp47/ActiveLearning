...
selected_images_df = pd.read_csv(SELECTED_IMAGES_CSV_PATH + "/sample_selection_log_Run3_s44.csv")
...
save_dir = os.path.abspath('D:/Shubham/results/multilabel01/DinoSmall/ActiveLearning/imagesFroMullticlass/withseed/avg_confidence/Run3_s44/')
