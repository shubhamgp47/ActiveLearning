...
val_df = pd.read_csv(df_dir + "/validation_v2024-03-18.csv")
test_df = pd.read_csv(df_dir + "/test_v2024-03-18.csv")
SELECTED_IMAGES_CSV_PATH = os.path.abspath("C:/Users/localuserSG/ActiveLearning/MultiLabel/imagesFroMullticlass/RandomSampling/DinoSmall/")  
selected_images_df = pd.read_csv(SELECTED_IMAGES_CSV_PATH + "/sample_selection_log_result02.csv")
...
save_dir = os.path.abspath('D:/Shubham/results/multilabel/imagesFroMullticlass/RandomSampling/Dinosmall')
