...
X_train_initial, y_train_initial = prepare_data(multiclass_train_df, image_dir, transform)
...
for i in range(3):
    ...
    y_pred_test = classifier.predict(X_test)  # Assuming X_test_np is your test data'''
    #classifier.fit(train_loader)  # Pass the train DataLoader

    # Use DataLoader for test data
    y_pred_test = classifier.predict(X_test)

    # Calculate test F1 score
    test_f1 = f1_score(y_test, y_pred_test, average='macro')  # Assuming y_test_np is your test labels
