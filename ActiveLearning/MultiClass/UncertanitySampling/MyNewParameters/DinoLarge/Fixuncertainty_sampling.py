...
if __name__ == "__main__":
    ...
    save_dir = os.path.abspath('D:/Shubham/results/US/Fixuncertainty_sampling/DinoL')
    ...
    class CustomDINONormModel(nn.Module):
        def __init__(self, dino_model, num_classes):
            ...
            self.classifier = nn.Sequential(
                ...
                nn.Linear(1024, 512),      # The output size of DINO ViT-S is 384
                nn.LayerNorm(512),
                nn.ReLU(),
                nn.Linear(512, 256),
    ...
    for i in range(n_queries):
        ...
        checkpoint_path = f"D:/Shubham/results/US/Fixuncertainty_sampling/DinoL/model_checkpoint_iteration_{i}.pt"
    ...
    performance_filename = "D:/Shubham/results/US/Fixuncertainty_sampling/DinoL/performance_results.npy"
