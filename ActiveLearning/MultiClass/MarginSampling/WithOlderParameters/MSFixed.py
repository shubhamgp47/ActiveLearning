...
save_dir = f"/home/woody/iwfa/iwfa044h/CleanLab_Test/ActiveLearningApproaches/results/fullyMacroWithmulticlassParameters/MSFixed/{run_id}"
...
initial_f1 = f1_score(y_test_class_indices, initial_y_pred, average='macro')
