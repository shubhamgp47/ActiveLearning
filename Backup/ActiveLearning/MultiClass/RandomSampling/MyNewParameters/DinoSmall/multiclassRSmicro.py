...
for i in range(no_of_iterations):
    ...
    checkpoint_path = f"/home/woody/iwfa/iwfa044h/CleanLab_Test/ActiveLearningApproaches/results/multiclass/MulticlassRS/MulticlassRS/MyNewParameters/DinoSmall/Micro/model_checkpoint_iteration_{i}.pt"
