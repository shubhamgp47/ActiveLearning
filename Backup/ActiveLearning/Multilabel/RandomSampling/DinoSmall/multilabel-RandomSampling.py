...
save_dir = f"/home/woody/iwfa/iwfa044h/CleanLab_Test/ActiveLearningApproaches/results/multilabel/RandomSampling/DinoSmall/{run_id}"
...
classifier = NeuralNetClassifier(
    ...
    max_epochs=100,
    train_split=predefined_split(valid_ds),  # Validation set split
    device=device,
    callbacks=[train_f1, valid_f1, es, model_checkpoint, csv_logger]
)
