...
def objective(trial):
    ...
    dino_repo_path = Path('/home/woody/iwfa/iwfa044h/CleanLab_Test/ActiveLearningApproaches/dino-main05')
    ...
    for epoch in range(num_epochs):
        ...
        if val_f1 > best_val_f1:
            ...
            torch.save(model.state_dict(), 'best_model05.pth')
        else:
...
study = optuna.create_study(
    study_name='optuna_study05',
    direction='maximize',
    storage='sqlite:///optuna_study05.db',
    load_if_exists=True,
...
best_model.load_state_dict(torch.load('best_model05.pth'))
...
pd.DataFrame(all_scores).to_csv("all_scores_DinoV2_XS_5_trials_learn_new_labels05.csv")