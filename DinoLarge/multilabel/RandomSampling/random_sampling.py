...
dropout = float(config['multilabel_DinoL_Parameters']['dropout'])
layer_freeze = config['multilabel_DinoL_Parameters']['layer_freeze']
criterion = eval(f"nn.{config['multilabel_DinoL_Parameters']['criterion']}")
batch_size = int(config['batch_size_8']['batch_size'])
optimizer = eval(f"optim.{config['multilabel_DinoL_Parameters']['optimizer']}")
lr = float(config['multilabel_DinoL_Parameters']['lr'])
patience = int(config['multilabel_DinoL_Parameters']['patience'])

'''predefined_image_names = ['Spule035_Image0269.jpg', 'Spule020_Image0191.jpg', 'Spule030_Image0310.jpg', 'Spule013_Image0317.jpg', 'Spule006_Image0201.jpg', 'Spule020_Image0292.jpg', 'Spule012_Image0854.jpg', 'Spule020_Image0498.jpg']
batch_size = 8
dropout = 0.28342120218398287
layer_freeze = 'blocks.7.ls2.gamma'
...
FILENAME = "random_sampling_results_for_multilabel_classification_s43.pickle"
NO_OF_ITERATIONS = 14
SPECIFIC_PATH = 'RandomSampling/Multilabel/DinoL/seed_43_100Epoch'
