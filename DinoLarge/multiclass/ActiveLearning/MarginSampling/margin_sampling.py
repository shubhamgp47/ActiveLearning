...
dropout = float(config['multiclass_DinoL_Parameters_1']['dropout'])
layer_freeze = config['multiclass_DinoL_Parameters_1']['layer_freeze']
criterion = eval(f"nn.{config['multiclass_DinoL_Parameters_1']['criterion']}")
optimizer = eval(f"optim.{config['multiclass_DinoL_Parameters_1']['optimizer']}")
lr = float(config['multiclass_DinoL_Parameters_1']['lr'])
patience = int(config['multiclass_DinoL_Parameters_1']['patience'])
step_size = int(config['multiclass_DinoL_Parameters_1']['step_size'])
gamma = float(config['multiclass_DinoL_Parameters_1']['gamma'])

POWER = 1
N_QUERIES = 13
FILENAME = "AL_margin_sampling_results_for_multiclass_classification_s43.pickle"
SPECIFIC_PATH = 'ActiveLearning/Multiclass/DinoL/margin_sampling_seed43_low_lr'
