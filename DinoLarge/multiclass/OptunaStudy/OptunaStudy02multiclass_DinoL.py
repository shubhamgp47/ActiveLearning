...
def print_hyperparameters(learning_rate, dropout, optimizer_name, momentum_term, step_size, gamma, layer_freeze_upto, batch_size):
    print(f"Learning rate: {learning_rate:.10f}")
    print(f"Dropout: {dropout}")
    print(f"Optimizer: {optimizer_name}")
    print(f"Momentum term: {momentum_term}")
    print(f"Number of frozen parameters: {layer_freeze_upto}")
...
study = optuna.create_study(
    study_name='optuna_study02multiclass_DinoL',
    direction='maximize',
    storage='sqlite:///OptunaStudy02multiclass_DinoL.db',
    load_if_exists=True
)
...
def objective(trial):
    ...
    print_hyperparameters(learning_rate, dropout, optimizer_name, momentum_term, step_size, gamma, layer_freeze_upto, batch_size)
